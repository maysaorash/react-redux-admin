              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div>The Last Breath</div>
                    </td>
                    <td className="text-center">
                      <CIcon height={15} name="cil-star" />  8.9
                    </td>
                    <td className="text-center"> Horror</td>
                    <td className="text-center"><CIcon name="cil-eye" />eye</td>
                    <td className="text-center">Unsubcriber</td>
                    <td className="text-center">23 July,2020</td>
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <CIcon height={15} name="cil-star" />  9.2
                    </td>
                    <td className="text-center"> Horror</td>
                    <td className="text-center"><CIcon name="cil-eye" />eye</td>
                    <td className="text-center">Unsubcriber</td>
                    <td className="text-center">21 July,2020</td>
                    <td className="text-center"><CIcon name="cil-heart" /></td>
                  </tr><tr>
                    <td className="text-center">
                      <div className="c-avatar">
                    ...
                    <td className="text-center">
                      <CIcon height={15} name="cil-star" />  8.5
                    </td>
                    <td className="text-center"> Action</td>
                    <td className="text-center"><CIcon name="cil-eye" />eye</td>
                    <td className="text-center">Unsubcriber</td>
                    <td className="text-center">24 July,2020</td>
                    <td className="text-center"><CIcon name="cil-heart" /></td>
                  </tr><tr>
                    <td className="text-center">
                      <div className="c-avatar">
                    ...
                    <td className="text-center">
                      <CIcon height={15} name="cil-star" />  7.2
                    </td>
                    <td className="text-center"> Horror</td>
                    <td className="text-center"><CIcon name="cil-eye" />eye</td>
                    <td className="text-center">Subcriber</td>
                    <td className="text-center">22 July,2020</td>
                    <td className="text-center"><CIcon name="cil-heart" /></td>
                  </tr>
                  <tr>
                    <td className="text-center">
                    ...
                    <td className="text-center"> Thriller</td>
                    <td className="text-center"><CIcon name="cil-eye" />eye</td>
                    <td className="text-center">Unsubcriber</td>
                    <td className="text-center">23 July,2020</td>
                    <td className="text-center"><CIcon name="cil-heart" /></td>
